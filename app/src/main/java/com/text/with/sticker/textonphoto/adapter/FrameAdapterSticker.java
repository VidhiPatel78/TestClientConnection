...
public class FrameAdapterSticker extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(this.mContext).load(Integer.valueOf(this.mContext.getResources().getIdentifier(this.valArr[position], "drawable", this.mContext.getPackageName()))).dontAnimate().placeholder((int) R.drawable.no_image).into(this.holder.mThumbnail);
