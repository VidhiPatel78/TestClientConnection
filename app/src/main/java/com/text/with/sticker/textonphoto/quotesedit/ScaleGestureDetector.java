...
public class ScaleGestureDetector {
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        @Override // com.textonphoto.customqoutescreator.quotesedit.ScaleGestureDetector.OnScaleGestureListener
        ...
        if (this.mGestureInProgress) {
            ...
            switch (action) {
                ...
                case 5:
                    ...
                    int pointerId = event.getPointerId(index1);
    ...
    /* JADX INFO: Multiple debug info for r7v5 float: [D('cvy' float), D('px0' float)] */
